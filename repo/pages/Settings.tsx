...
const Settings: React.FC = () => {
  ...
  return (
    <div className="space-y-6 sm:space-y-8 page-container">
      ...
      <div className="card-premium p-2 sm:p-6 rounded-lg sm:rounded-xl shadow-lg">
        ...
        <div className="flex flex-wrap gap-3 sm:gap-4">
          <button
            ...
            className="px-3 sm:px-4 py-2 sm:py-3 bg-[var(--accent)] text-white rounded-md hover:bg-accent-light transition text-center leading-tight"
          >
            Sign in with Google
          </button>
          <button
            onClick={() => signOutUser()}
            className="px-3 sm:px-4 py-2 sm:py-3 bg-[rgba(24,24,24,0.9)] text-white rounded-md ring-1 ring-white/10 hover:bg-[rgba(24,24,24,0.75)] transition text-center leading-tight"
          >
            Sign out
          </button>
        </div>
      ...
      <div className="card-premium p-3 sm:p-6 rounded-lg sm:rounded-xl shadow-lg">
        ...
        <button
          ...
          className="px-3 sm:px-4 py-2 sm:py-3 bg-[rgba(24,24,24,0.9)] text-white rounded-md ring-1 ring-white/10 hover:bg-[rgba(24,24,24,0.75)] transition disabled:opacity-50 text-center leading-tight"
        >
        ...
        {fcmToken && (
          <div className="mt-3 space-y-2">
            ...
            <div className="bg-[rgba(24,24,24,0.9)] border border-white/10 p-3 rounded-md">
              <code className="text-xs break-all text-gray-300">{fcmToken}</code>
            </div>
            <button
              onClick={() => navigator.clipboard.writeText(fcmToken)}
              className="px-3 py-2 bg-[rgba(24,24,24,0.9)] text-white rounded-md ring-1 ring-white/10 hover:bg-[rgba(24,24,24,0.75)] transition text-center leading-tight"
            >
              Copy Token
            </button>
          </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {(schedulerActivity.universe_symbols || []).map(s => (
                  <span key={s} className="px-2 py-1 rounded-md bg-[rgba(255,255,255,0.06)] text-gray-200 text-xs ring-1 ring-white/10">{s}</span>
                ))}
              </div>
            </div>
      ...
      <div className="card-premium p-3 sm:p-6 rounded-lg sm:rounded-xl shadow-lg">
        ...
        <div className="flex flex-wrap gap-4">
          <button
            ...
            className="w-full sm:w-auto px-3 sm:px-4 py-2 sm:py-3 bg-[rgba(24,24,24,0.9)] text-white rounded-md ring-1 ring-white/10 hover:bg-[rgba(24,24,24,0.75)] transition text-center leading-tight"
          >
            Export All Data
          </button>
          <label className="w-full sm:w-auto px-4 py-3 bg-[rgba(24,24,24,0.9)] text-white rounded-md ring-1 ring-white/10 hover:bg-[rgba(24,24,24,0.75)] transition cursor-pointer inline-flex items-center text-center leading-tight">
      ...
      <div className="card-premium p-3 sm:p-6 rounded-lg sm:rounded-xl shadow-lg">
        ...
        <pre className="bg-[rgba(24,24,24,0.9)] border border-white/10 p-3 sm:p-4 rounded-md text-sm text-gray-300 overflow-x-auto">
       ...
       <div className="card-premium p-3 sm:p-6 rounded-lg sm:rounded-xl shadow-lg">
        ...
        <div className="flex space-x-3 sm:space-x-4">
            <button
              ...
              className="px-4 py-3 bg-gray-700 text-white rounded-md hover:bg-gray-600 transition text-center leading-tight"
            >
              Run Price Check Job
            </button>
        </div>
        ...
        <form onSubmit={handleTestWebhook} className="space-y-3 sm:space-y-4">
            ...
            />
            <button type="submit" className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-[rgba(24,24,24,0.9)] text-white rounded-md ring-1 ring-white/10 hover:bg-[rgba(24,24,24,0.75)] transition text-center leading-tight">
                Send Test Alert
            </button>
        </form>
      </div>
