        ...
        <table className="min-w-full">
          <thead className="bg-gray-700">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">TP (R)</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Stop Logic</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Enabled</th>
          ...
          <tbody className="bg-gray-800 divide-y divide-gray-700">
            {strategies?.map(s => (
              <tr key={s.id}>
                <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-white">{s.name}</td>
                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-300">{s.symbol}</td>
                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-300">{s.risk_per_trade_gbp}</td>
                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-300">{s.take_profit_R}</td>
                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-300">{s.stop_logic}</td>
